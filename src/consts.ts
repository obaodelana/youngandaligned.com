...
export const DEFAULT_OG_IMAGE = `${SITE_URL}/images/logos/ya_big.png`;

// Primary social profiles (used in Organization JSON-LD `sameAs`).
export const SOCIAL_PROFILES: string[] = [
  'https://www.instagram.com/youngandalignedofficial',
];